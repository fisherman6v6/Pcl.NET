...
{
    public class CropBoxPointXYZIUnitTest
    {
        [Fact]
        public void CropBoxPointXYZI_Filter_FiltersCorrectly()
        {
            var cloud = new PointCloudXYZI(2, 2);
            cloud.Add(new PointXYZI(0, 0, 0, 0));
            cloud.Add(new PointXYZI(1, 1, 1, 0));
            cloud.Add(new PointXYZI(2, 2, 2, 0));
            cloud.Add(new PointXYZI(3, 3, 3, 0));
            var cropBox = new CropBoxPointXYZI
            {
        ...
        [Fact]
        public void CropBoxPointXYZI_Properties_WorkCorrectly()
        {
            var cropBox = new CropBoxPointXYZI();
        ...
        [Fact]
        public void CropBoxPointXYZI_Indices_SetAndGet()
        {
            var cropBox = new CropBoxPointXYZI();
