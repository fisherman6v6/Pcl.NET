...
EXPORT(type*) pointcloud_xyz_at_colrow(pointcloud_t* ptr, int col, int row);

EXPORT(void) pointcloud_xyz_add(pointcloud_t* ptr, type* value);
...
EXPORT(type*) pointcloud_xyz_data(pointcloud_t* ptr);
