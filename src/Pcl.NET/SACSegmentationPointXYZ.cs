...
namespace Pcl.NET
{
    public class SACSegmentationPointXYZ : SACSegmentation<PointXYZ>
    {
        private readonly VectorInt _indices;
        private PointCloud<PointXYZ>? _input = null;

        public SACSegmentationPointXYZ()
        {
            _indices = new VectorInt();
            _ptr = Invoke.sacsegmentation_pointxyz_ctor();
        }
        ...
        public override SacModel ModelType
        {
            ...
            {
                ThrowIfDisposed();
                return (SacModel)Invoke.sacsegmentation_pointxyz_get_model_type(_ptr);
            }
            set
            {
                ThrowIfDisposed();
                Invoke.sacsegmentation_pointxyz_set_model_type(_ptr, (int)value);
            }
        }
        ...
        public override SacMethod MethodType
        {
            ...
            {
                ThrowIfDisposed();
                return (SacMethod)Invoke.sacsegmentation_pointxyz_get_method_type(_ptr);
            }
            set
            {
                ThrowIfDisposed();
                Invoke.sacsegmentation_pointxyz_set_method_type(_ptr, (int)value);
            }
        }
        ...
        public override double DistanceThreshold
        {
            ...
            {
                ThrowIfDisposed();
                return Invoke.sacsegmentation_pointxyz_get_distance_threshold(_ptr);
            }
            set
            {
                ThrowIfDisposed();
                Invoke.sacsegmentation_pointxyz_set_distance_threshold(_ptr, value);
            }
        }
        ...
        public override int MaxIterations
        {
            ...
            {
                ThrowIfDisposed();
                return Invoke.sacsegmentation_pointxyz_get_max_iterations(_ptr);
            }
            set
            {
                ThrowIfDisposed();
                Invoke.sacsegmentation_pointxyz_set_max_iterations(_ptr, value);
            }
        }
        ...
        public override bool OptimizeCoefficients
        {
            ...
            {
                ThrowIfDisposed();
                return Invoke.sacsegmentation_pointxyz_get_optimize_coefficients(_ptr);
            }
            set
            {
                ThrowIfDisposed();
                Invoke.sacsegmentation_pointxyz_set_optimize_coefficients(_ptr, value);
            }
        }
        ...
        {
            ThrowIfDisposed();
            Invoke.sacsegmentation_pointxyz_set_radius_limits(_ptr, minRadius, maxRadius);
        }

        public override void GetRadiusLimits(ref double minRadius, ref double maxRadius)
        {
            ThrowIfDisposed();
            Invoke.sacsegmentation_pointxyz_get_radius_limits(_ptr, ref minRadius, ref maxRadius);
        }
        ...
        public override float[] Segment()
        {
            ...
            {
                Invoke.sacsegmentation_pointxyz_segment(_ptr, inliers, coeff);
        ...
        public override PointCloud<PointXYZ>? Input
        {
            ...
            set
            {
                ...
                Invoke.sacsegmentation_pointxyz_set_input_cloud(_ptr, value!);
                _input = value;
            }
        }
        ...
        public override void SetIndices(long row_start, long col_start, long nb_rows, long nb_cols)
        {
            ...
            Invoke.sacsegmentation_pointxyz_set_indices(_ptr, (ulong)row_start, (ulong)col_start, (ulong)nb_rows, (ulong)nb_cols);
        }
        /// <summary>
        ...
        public override VectorInt Indices
        {
            ...
            {
                ThrowIfDisposed();
                Invoke.sacsegmentation_pointxyz_get_indices_vector(_ptr, _indices);
                return _indices;
            }
            ...
            {
                ThrowIfDisposed();
                Invoke.sacsegmentation_pointxyz_set_indices_vector(_ptr, value);
            }
        }
        ...
        protected override void DisposeObject()
        {
            if (!_suppressDispose)
            {
                Invoke.sacsegmentation_pointxyz_delete(ref _ptr);
            }
        }
